        ...
        <div style={{ paddingTop: "clamp(70px, 10vw, 100px)" }}>
          ...
          {!showMyList && (
            <>
                  ...
                  >
                    {[
                      ...
                      <div key={i}>
                        ...
                        <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "clamp(11px, 1.3vw, 13px)", fontWeight: "600" }}>
                          {stat.label}
                        </div>
                      </div>
                    ))}
              ...
              {!searchResults && (
                <div style={{
                  background: isDark ? "rgba(2,8,24,0.75)" : "rgba(255,240,245,0.75)",
                ...
                {selectedMood && (
                  <motion.div
                    ...
                    style={{
                      ...
                      marginBottom: 40,
                      background: isDark ? "rgba(2,8,24,0.85)" : "rgba(255,240,245,0.85)",
                      backdropFilter: "blur(16px)",
                    }}
                  >
                    <h2 style={{
              ...
              {!searchResults && (
                <div style={{
                  background: isDark ? "rgba(2,8,24,0.88)" : "rgba(255,240,245,0.88)",
                  backdropFilter: "blur(20px)",
