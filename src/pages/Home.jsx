...
export default function Home({ user, onLogout }) {
  ...
  showToast(`Note saved for "${anime.title_english || anime.title}" 📝`)
}
  ...
  return (
    ...
    >
      ...
      <div style={{ paddingTop: "clamp(70px, 10vw, 100px)" }}>
        ...
        {/* Main content — hidden when MyList is open */}
        {!showMyList && (
          <>
            {/* Search results */}
            <AnimatePresence>
            ...
            <AnimatePresence>
              {selectedMood && (
                ...
                >
                  ...
                  >
                    {selectedMood.emoji} {selectedMood.label} Picks — just for
                    you
                  </h2>
            ...
            {!searchResults && (
              <>
                ...
                <AnimeRow
                  title="Magic & Sorcery"
                  emoji="✨"
                  fetchFn={() => getByGenre(GENRES.magic)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                ...
                <AnimeRow
                  title="Shounen"
                  emoji="👊"
                  fetchFn={() => getByGenre(GENRES.shounen)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                <AnimeRow
                  ...
                  emoji="😈"
                  fetchFn={() => getByGenre(GENRES.demons)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                <AnimeRow
                  title="Mecha"
                  emoji="🤖"
                  fetchFn={() => getByGenre(GENRES.mecha)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                <AnimeRow
                  title="Sports"
                  emoji="🏆"
                  fetchFn={() => getByGenre(GENRES.sports)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                <AnimeRow
                  title="Historical"
                  emoji="⚔️"
                  fetchFn={() => getByGenre(GENRES.historical)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
                <AnimeRow
                  title="School Life"
                  emoji="🏫"
                  fetchFn={() => getByGenre(GENRES.school)}
                  watchlist={watchlist}
                  onAdd={handleAdd}
                  onRate={handleRate}
                />
